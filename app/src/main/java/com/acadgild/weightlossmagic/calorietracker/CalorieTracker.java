...
import com.acadgild.weightlossmagic.calorietracker.database.DBAdapter;
...
import com.acadgild.weightlossmagic.weeklytracker.database.*;
            ...
            public void onClick(View view) {
             ...
             btnSave=(Button)d.findViewById(R.id.btnCSave);
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                   DBAdapter db=new DBAdapter(CalorieTracker.this);
                        db.openDB();
                        try {
